# -*- coding: utf-8 -*-
"""
Created on Thu Mar 10 14:46:58 2016
...
import numpy as np
import pandas as pd
from OneVsRestSVClassifier import OneVsRest
from AllPairsSVClassifier import AllPairs
...
print('One vs rest with SVC: Mean={:.1%}, SD={:.1%}'.format(
        accuracy[0].mean(), accuracy[0].std()))
print('All pairs with SVC: Mean={:.1%}, SD={:.1%}'.format(
        accuracy[1].mean(), accuracy[1].std()))

        
plt.figure(figsize=(20, 10))
labels = ('One vs rest with SVC', 'All pairs with SVC')
